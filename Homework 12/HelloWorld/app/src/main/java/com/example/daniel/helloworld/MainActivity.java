...
public class MainActivity extends Activity implements TextureView.SurfaceTextureListener {
    ...
    public void onSurfaceTextureUpdated(SurfaceTexture surface) {
        ...
        if (c != null) {
            ...
            for (int startY = 50; startY <= 150; startY+=10) {
...
//                        pixels[i] = rgb(255, 0, 0); // over write the pixel with pure red
                ...
                if (counter != 0) {
                    COM[(startY/10)-5] = middle / counter;
//                    canvas.drawCircle(COM[(startY/10)-5], startY,5 , paint1); // x position, y position, diameter, color
                }
